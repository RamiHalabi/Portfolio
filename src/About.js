...
const About = () => {
  ...
  const AboutInfo = [
    ...
    [
      "As a Junior Developer, I am eager to learn and solve problems to make meaningful contributions to my work. I have been described as communicative, adaptable, and regularly maintain an affable demeanor.",
    ],
  ...
  const aboutSection = AboutInfo.map(function (element) {
    ...
    return (
      <>
        <div className="styling">{sectionMap}</div>
      </>
    );
  });
  ...
  return (
    <>
      <div className="img">
        <img alt="pfp" title="Profile Pic" src={pfp} className="pfp" />
      </div>
